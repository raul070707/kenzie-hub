...
const Register = ({ authenticated }) => {
    ...
    const schema = yup.object().shape({
        ...
        password: yup.string().required('Campo obrigatório').min(8, 'Sua senha deve conter no minimo 8 caracteres'),
        confirmPassword: yup.string().required('Campo obrigatório').oneOf([yup.ref('password'), null], 'Senha diferente'),
        contact: yup.string().required('Campo Obrigatório').min(9, 'Este campo deve conter 9 digitos').max(9, 'Este campo deve conter 9 digitos'),
